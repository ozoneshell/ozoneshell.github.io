...
- They shouldn't be AI (vibe coded). No over commenting.
- New code will be reviewed and optimized to align with the goals of Ozone.

You can also contibute by posting an Issue. Or texting me an idea you've had. PRs would also be less likely to merge if its touching the core components.